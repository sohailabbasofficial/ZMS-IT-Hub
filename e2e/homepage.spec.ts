...
test.describe('Homepage', () => {
  test('should load homepage successfully', async ({ page }) => {
    ...
    await expect(
      page.getByRole('heading', { name: /Transform Your Business/ })
    ).toBeVisible();

    // Check for CTA buttons
    await expect(
      page.getByRole('link', { name: /Get Free Quote/ })
    ).toBeVisible();
    await expect(
      page.getByRole('link', { name: /View Our Work/ })
    ).toBeVisible();
  });
  ...
  test('should display services section', async ({ page }) => {
    ...
    await expect(
      page.getByRole('heading', { name: /Our Core Services/ })
    ).toBeVisible();
  ...
  test('should display testimonials', async ({ page }) => {
    ...
    await page
      .getByRole('heading', { name: /What Our Clients Say/ })
...
test.describe('Contact Form', () => {
  test('should submit contact form successfully', async ({ page }) => {
    ...
    await page.fill(
      ...
      'I need help with a custom software project.'
    );
...
test.describe('Navigation', () => {
  test('should navigate between pages', async ({ page }) => {
    ...
    await expect(
      page.getByRole('heading', { name: /About ZMS IT Hub/ })
    ).toBeVisible();
    ...
    await expect(
      page.getByRole('heading', { name: /Our Software Development Services/ })
    ).toBeVisible();
