    ...
    <>
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <button
          ...
          className="group relative flex h-14 w-14 items-center justify-center rounded-2xl bg-green-500 text-white shadow-lg transition-all duration-300 hover:bg-green-600 hover:shadow-xl hover:-translate-y-1 focus:outline-none focus:ring-4 focus:ring-green-300 animate-pulse"
