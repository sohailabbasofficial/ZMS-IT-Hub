...
export const metadata: Metadata = {
  ...
  description: 'Stay updated with the latest insights on software development, technology trends, and business solutions from ZMS IT Hub experts.',
  keywords: [
...
const blogPosts = [
  {
    ...
    title: 'The Complete Guide to Custom Software Solutions for Businesses in 2025',
    slug: 'complete-guide-custom-software-solutions-2025',
    excerpt: 'Comprehensive guide covering why custom software solutions are essential for modern businesses. Detailed analysis of efficiency, scalability, security, competitive advantages, and real-world success stories.',
    author: 'ZMS IT Hub',
    publishedAt: '2025-01-15',
    readTime: '12 min read',
    category: 'Complete Business Guide',
    featuredImage: '/images/blog/complete-guide-2025.jpg',
    tags: ['Custom Software', 'Business Solutions', 'Complete Guide', 'Technology Trends'],
  },
  {
    ...
    excerpt: 'Discover why custom software solutions are essential for modern businesses. Learn about efficiency, scalability, security, and competitive advantages that drive success in 2025.',
    author: 'ZMS IT Hub',
    publishedAt: '2025-01-15',
    readTime: '8 min read',
        ...
        <Container>
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mb-8 text-xl text-white/90">
              Stay updated with the latest insights on software development, technology trends, and business solutions.
            </p>
          </div>
        </Container>
      </section>
          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-4">
            ...
            <aside className="lg:col-span-1">
              <div className="sticky top-8 space-y-8">
                ...
                <div className="rounded-lg bg-white p-6 shadow-lg">
                  <h3 className="mb-4 text-lg font-semibold text-secondary">Categories</h3>
                ...
                {/* Recent Posts */}
                <div className="rounded-lg bg-white p-6 shadow-lg">
                  <h3 className="mb-4 text-lg font-semibold text-secondary">Recent Posts</h3>
                  <div className="space-y-4">
                    {blogPosts.slice(0, 3).map((post) => (
                      <div key={post.id} className="border-b border-gray-100 pb-4 last:border-b-0 last:pb-0">
                        ...
                        >
                          <h4 className="mb-2 text-sm font-medium leading-tight">{post.title}</h4>
            ...
            <main className="lg:col-span-3">
              <div className="space-y-8">
                {blogPosts.map((post) => (
                  <article key={post.id} className="card group overflow-hidden transition-all duration-300 hover:-translate-y-1">
                        ...
                        <div className="relative h-48 w-full overflow-hidden rounded-lg bg-gradient-to-br from-primary via-primary-dark to-primary">
                          <div className="absolute inset-0 flex items-center justify-center">
                            <div className="rounded-full bg-white/20 p-6 backdrop-blur-sm">
                              <Logo width={80} height={80} showText={false} href="" />
                            </div>
                          </div>
                          {/* Decorative elements */}
                          <div className="absolute top-4 right-4 h-8 w-8 rounded-full bg-white/10"></div>
              ...
              <div className="mt-12 flex justify-center">
                <div className="flex items-center space-x-2">
                  <button
                    disabled
                    className="rounded-lg bg-gray-100 px-4 py-2 text-gray-400 cursor-not-allowed"
                  >
                    Previous
                  </button>
                  <button className="rounded-lg bg-primary px-4 py-2 text-white">1</button>
                  <button
                    disabled
                    className="rounded-lg bg-gray-100 px-4 py-2 text-gray-400 cursor-not-allowed"
                  >
      ...
      <section className="section-padding bg-primary text-white">
        <Container>
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mb-8 text-xl text-white/90">
              Let's discuss how custom software solutions can drive your business forward.
            </p>
